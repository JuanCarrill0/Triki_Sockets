...
public class VistaJuego extends javax.swing.JFrame {
    ...
    public Controlador getControl(){
        if(control == null){
            control = new Controlador(this,null);
        }
        return control;
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(380, 520));
        setPreferredSize(new java.awt.Dimension(380, 520));

        jPanel1.setBackground(new java.awt.Color(5, 0, 87));

        lienzo.setFont(new java.awt.Font("Lucida Console", 0, 12)); // NOI18N
        lienzo.setForeground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lienzo, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(lienzo, javax.swing.GroupLayout.PREFERRED_SIZE, 359, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(25, 25, 25)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        getMiModelo().setReiniciar(true);
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
         getMiModelo().getVentanaJuego().setVisible(false);
         getMiModelo().getVentanaMenu().setVisible(true);
         getMiModelo().setReiniciar(true);
